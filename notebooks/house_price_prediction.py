...
for col in all_data.columns:
    if all_data[col].isnull().sum() > 0:
        if all_data[col].dtype == 'object':  # Categorical - Fixed np.object to 'object'
...
models = {
    ...
    "XGBoost": xgb.XGBRegressor(colsample_bytree=0.8, gamma=0.0, learning_rate=0.05, max_depth=4, min_child_weight=1.5, n_estimators=2200, reg_alpha=0.9, reg_lambda=0.6, subsample=0.8, random_state=7, verbosity=0)
}
